...
const sendEmail = (e) => {
    ...
    if(contactName.value === '' || 
        ...
        emailjs.sendForm('service_0f6ldhb', 'template_rf082n8', '#contact-form', 'AmNxwiclwQrYSlgLD').then(
            () => {
...
sr.reveal('.home-data');
sr.reveal('.home-img-wrapper', {delay: 300});
sr.reveal('.home-social', {delay: 400});
sr.reveal('.services-card, .mix', {interval: 100});
sr.reveal('.skills-cp, .resume-left, .contact-group', {origin: 'left'});
sr.reveal('.skills-dev, .resume-right, .contact-form', {origin: 'right'});
